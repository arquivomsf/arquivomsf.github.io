    ...
    fetch(`video/${consoleAtual}/${jogoAtual}/series.json`)
      ...
      .then(data => {
        ...
        if (data.hasOwnProperty("episodios")) {
          let opnome = data.episodios[0].nome;
          let opimagem = data.episodios[0].imagem;
          let opquantidade = data.episodios[0].quantidade;
          document.querySelector("#jsonParent").innerHTML += `
              <div class="col">
                <a href="serie?con=${consoleAtual}&jogo=${jogoAtual}&serie=episodios" class="blacklink">
                  <div class="thumbnail">
                    <img src="video/${consoleAtual}/${jogoAtual}/episodios/${opimagem}" alt="" class="img-fluid linkicon">
                    <div class="playlist-length">
                      <div class="playlist-info-wrapper">
                        <i class="fa fa-list"></i>
                        <span>${opquantidade}</span>
                      </div>
                    </div>
                  </div>
                  <span class="flow-text title">${opnome}</span>
                </a>
              </div>`;
        }

        if (data.hasOwnProperty("vodsoficiais")) {
          let opnome = data.vodsoficiais[0].nome;
          let opimagem = data.vodsoficiais[0].imagem;
          let oplink = data.vodsoficiais[0].link;
          let opquantidade = data.vodsoficiais[0].quantidade;
          document.querySelector("#jsonParent").innerHTML += `
              <div class="col">
                <a href="${oplink}" target="_blank" class="blacklink">
                  <div class="thumbnail">
                    <img src="video/${consoleAtual}/${jogoAtual}/vodsoficiais.${opimagem}" alt="" class="img-fluid linkicon">
                    <div class="playlist-length">
                      <div class="playlist-info-wrapper">
                        <i class="fa fa-list"></i>
                        <span>${opquantidade}</span>
        ...
        if (data.hasOwnProperty("vodsarquivo")) {
          let opnome = data.vodsarquivo[0].nome;
          let opimagem = data.vodsarquivo[0].imagem;
          let opquantidade = data.vodsarquivo[0].quantidade;
          document.querySelector("#jsonParent").innerHTML += `
              <div class="col">
                <a href="serie?con=${consoleAtual}&jogo=${jogoAtual}&serie=vods" class="blacklink">
                  <div class="thumbnail">
                    <img src="video/${consoleAtual}/${jogoAtual}/vods/${opimagem}" alt="" class="img-fluid linkicon">
                    <div class="playlist-length">
                      <div class="playlist-info-wrapper">
                        <i class="fa fa-list"></i>
                        <span>${opquantidade}</span>
        ...
        if (data.hasOwnProperty("analise")) {
          ...
          document.querySelector("#jsonParent").innerHTML += `
            <div class="col">
              <a href="${oplink}" target="_blank" class="blacklink">
                <div class="thumbnail">
                  <img src="video/${consoleAtual}/${jogoAtual}/analise.${opimagem}" alt="" class="img-fluid linkicon">
                  <span class="video-length"><i class="fa fa-fw fa-youtube-play"></i>${opduracao}</span>
                </div>
                <span class="flow-text title">${opnome}</span>
              </a>
            </div>`;
