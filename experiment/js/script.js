...
function setPesquisa() {
    if (pesquisando == 0) {
        document.querySelector("#inputPesquisa").classList.toggle('not-searching');
        document.querySelector("#pesquisarBtn").classList.toggle('not-searching');
        document.querySelector("#inputPesquisa").classList.toggle('searching');
        document.querySelector("#pesquisarBtn").classList.toggle('searching');
        document.querySelector(".navbar-brand").style.opacity = 1;
        document.querySelector(".navbar-toggler").style.opacity = 1;
        document.querySelector("#inputPesquisaContainer").style.zIndex = -1;
        ...
        document.querySelector(".navbar-toggler").style.opacity = 0;
        document.querySelector("#inputPesquisaContainer").style.zIndex = 1;
